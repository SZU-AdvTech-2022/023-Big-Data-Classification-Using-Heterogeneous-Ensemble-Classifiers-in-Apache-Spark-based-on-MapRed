...
object AdaBoostDecisionTree1 {
    ...
    def main(args: Array[String]): Unit = {
        ...
        val spark: SparkSession = SparkSession
            .builder
            .appName("AdaBoostDecisionTree_Higges")
            .getOrCreate()

        // 写入配置
        val path = "hdfs://172.31.238.20:8020/user/chandler/recurrence/higges/AdaBoostDecisionTree1/"
        log.append("job,AdaBoostDecisionTree_Higges\n")

        // 加载数据，并进行类型转换
        val dataFrame = spark
            .read.format("csv")
            .load("hdfs://172.31.238.20:8020/user/chandler/recurrence/higges/train/repartationRdd/part-00001*.csv")// 加载第0个分区
        ...
        val modelArray: Array[DecisionTreeClassificationModel] = new Array[DecisionTreeClassificationModel](maxIter)
