...
object RandomForest {
    ...
    def main(args: Array[String]): Unit = {
        ...
        // 写入配置
        val path = "hdfs://172.31.238.20:8020/user/chandler/recurrence/susy/RandomForest/"
        log.append("job,GBT_Susy\n")

        // 加载数据，并进行类型转换
        val dataFrame = spark
            .read.format("csv")
            .load("hdfs://172.31.238.20:8020/user/chandler/recurrence/susy/train/part-00000*.csv") // 加载所有数据
