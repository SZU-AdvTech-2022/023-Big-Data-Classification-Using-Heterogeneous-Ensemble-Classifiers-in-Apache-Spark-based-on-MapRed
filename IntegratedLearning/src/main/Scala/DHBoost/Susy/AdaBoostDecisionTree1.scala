...
object AdaBoostDecisionTree1 {
    ...
    def main(args: Array[String]): Unit = {
        ...
        // 写入配置
        val path = "hdfs://172.31.238.20:8020/user/chandler/recurrence/susy/AdaBoostDecisionTree1/"
        log.append("job,AdaBoostDecisionTree_Susy\n")

        // 加载数据，并进行类型转换
        val dataFrame = spark
            .read.format("csv")
            .load("hdfs://172.31.238.20:8020/user/chandler/recurrence/susy/train/repartationRdd/part-00001*.csv")// 加载第1个分区
